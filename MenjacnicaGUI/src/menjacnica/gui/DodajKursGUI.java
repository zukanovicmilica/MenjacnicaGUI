...
public class DodajKursGUI extends JFrame {
	...
	private MenjacnicaGUI menjacnica= new MenjacnicaGUI();

	/**
	 * Create the frame.
	 */
	public DodajKursGUI(MenjacnicaGUI menj) {
		super();
		menjacnica= menj;
		setResizable(false);
		...
		btnDodaj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String s = "Sifra: " + textFieldSifra.getText() + " Naziv: " + textFieldNaziv.getText()
						+ " Skraceni naziv: " + textFieldSkraceniNaziv.getText() + " Prodajni kurs: "
						+ textFieldProdajni.getText() + " Kupovni kurs: " + textFieldKupovni.getText()
						+ " Srednji kurs: " + textFieldSrednji.getText()+'\n';
				menjacnica.textAreaStatus.append("Dodat je kurs: "+s);
				dispose();
			}
		});
